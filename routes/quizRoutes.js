...
import { getQuizzes, createQuiz, deleteQuiz, updateQuiz, deleteQuestionFromQuiz, getQuizById } from "../controllers/quizController.js"
import { protect } from "../middleware/authMiddelware.js";

const router = express.Router();

router.get("/getQuiz",protect, getQuizzes);
router.get("/getQuizById/:id",protect, getQuizById);
